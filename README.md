...
- 📌 Access & Refresh 인증 관리
    ...
    ![image.png](attachment:c3f13adf-7579-408d-98ea-36345d64342a:image.png)
...
- 📌 동시성 제어
    ...
    ![image.png](attachment:7681b480-f3f1-499b-b9b9-ab75e90c08be:image.png)
...
- 📌 로그 기록 조회 성능 개선 (캐시 적용 전/후)
    ...
    ![캐시적용전.png](attachment:6524dc7e-b43f-425e-8e0c-34d28bbceb6a:캐시적용전.png)
    
    ### ⏳ 캐시 적용 후 19ms
    
    ![캐시적용후.png](attachment:26ffda56-9472-4ea4-8848-3def0e7dd78a:캐시적용후.png)
...
정은서 - [GitHub](https://github.com/eunseo04)# 📦 E-Commerce Platform 📦
...
![image](attachment:c3f13adf-7579-408d-98ea-36345d64342a:image.png)
...
### 동시성 테스트 속도 비교
![image](attachment:7681b480-f3f1-499b-b9b9-ab75e90c08be:image.png)
